...
+pad(d.getUTCHours())+':'
+pad(d.getUTCMinutes())+':'
+pad(d.getUTCSeconds())+'Z';},isValidDate:function(d){return Object.prototype.toString.call(d)==='[object Date]'&&!isNaN(d.getTime());},safe:function(fn,context){if(typeof fn==='function'){return function(){var args=Array.prototype.slice.call(arguments,0);try{return fn.apply(context||this,args);}
